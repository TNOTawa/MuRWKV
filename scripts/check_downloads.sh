...
echo "downloaded: ${S} GB / 307.17 GB"
pgrep -f '^python3 .*fetch_parallel' > /dev/null && echo "download process: RUNNING" || echo "download process: DEAD"
tail -2 /root/autodl-tmp/data/slakh_yourmt3_16k/fetch3.log 2>/dev/null
